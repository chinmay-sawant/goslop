...
var (
	MetaCWE396 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(396, "Declaration of Catch for Generic Exception", "https://cwe.mitre.org/data/definitions/396.html")},
	...
	MetaCWE397 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(397, "Declaration of Throws for Generic Exception", "https://cwe.mitre.org/data/definitions/397.html")},
	...
	MetaCWE478 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(478, "Missing Default Case in Multiple Condition Expression", "https://cwe.mitre.org/data/definitions/478.html")},
	...
	MetaCWE252 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(252, "Unchecked Return Value", "https://cwe.mitre.org/data/definitions/252.html")},
	...
	MetaCWE390 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(390, "Detection of Error Condition Without Action", "https://cwe.mitre.org/data/definitions/390.html")},
	...
	MetaCWE584 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(584, "Return Inside Finally Block", "https://cwe.mitre.org/data/definitions/584.html")},
