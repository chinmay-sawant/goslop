...
var (
	MetaCWE88 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(88, "Improper Neutralization of Argument Delimiters in a Command ('Argument Injection')", "https://cwe.mitre.org/data/definitions/88.html")},
	...
	MetaCWE94 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(94, "Improper Control of Generation of Code ('Code Injection')", "https://cwe.mitre.org/data/definitions/94.html")},
	...
	MetaCWE117 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(117, "Improper Output Neutralization for Logs", "https://cwe.mitre.org/data/definitions/117.html")},
