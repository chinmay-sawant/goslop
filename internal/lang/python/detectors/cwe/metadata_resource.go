...
var (
	MetaCWE434 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(434, "Unrestricted Upload of File with Dangerous Type", "https://cwe.mitre.org/data/definitions/434.html")},
	...
	MetaCWE427 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(427, "Uncontrolled Search Path Element", "https://cwe.mitre.org/data/definitions/427.html")},
	...
	MetaCWE379 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(379, "Creation of Temporary File in Directory with Insecure Permissions", "https://cwe.mitre.org/data/definitions/379.html")},
	...
	MetaCWE459 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(459, "Incomplete Cleanup", "https://cwe.mitre.org/data/definitions/459.html")},
	...
	MetaCWE772 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(772, "Missing Release of Resource after Effective Lifetime", "https://cwe.mitre.org/data/definitions/772.html")},
	...
	MetaCWE770 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(770, "Allocation of Resources Without Limits or Throttling", "https://cwe.mitre.org/data/definitions/770.html")},
	...
	MetaCWE708 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(708, "Incorrect Ownership Assignment", "https://cwe.mitre.org/data/definitions/708.html")},
	...
	MetaCWE477 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(477, "Use of Obsolete Function", "https://cwe.mitre.org/data/definitions/477.html")},
