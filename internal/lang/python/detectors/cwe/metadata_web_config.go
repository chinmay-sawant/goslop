...
var (
	MetaCWE756 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-756"), "Missing Custom Error Page", "https://cwe.mitre.org/data/definitions/756.html")},
	...
	MetaCWE489 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-489"), "Active Debug Code", "https://cwe.mitre.org/data/definitions/489.html")},
	...
	MetaCWE15 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-15"), "External Control of System or Configuration Setting", "https://cwe.mitre.org/data/definitions/15.html")},
	...
	MetaCWE1051 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-1051"), "Initialization with Hard-Coded Network Resource Configuration Data", "https://cwe.mitre.org/data/definitions/1051.html")},
	...
	MetaCWE1052 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-1052"), "Excessive Use of Hard-Coded Literals in Initialization", "https://cwe.mitre.org/data/definitions/1052.html")},
	...
	MetaCWE1125 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-1125"), "Excessive Attack Surface", "https://cwe.mitre.org/data/definitions/1125.html")},
	...
	MetaCWE1188 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-1188"), "Initialization of a Resource with an Insecure Default", "https://cwe.mitre.org/data/definitions/1188.html")},
	...
	MetaCWE921 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-921"), "Storage of Sensitive Data in a Mechanism without Access Control", "https://cwe.mitre.org/data/definitions/921.html")},
