...
var (
	MetaCWE306 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-306"), "Missing Authentication for Critical Function", "https://cwe.mitre.org/data/definitions/306.html")},
	...
	MetaCWE307 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-307"), "Improper Restriction of Excessive Authentication Attempts", "https://cwe.mitre.org/data/definitions/307.html")},
	...
	MetaCWE346 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-346"), "Origin Validation Error", "https://cwe.mitre.org/data/definitions/346.html")},
	...
	MetaCWE359 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-359"), "Exposure of Private Personal Information to an Unauthorized Actor", "https://cwe.mitre.org/data/definitions/359.html")},
	...
	MetaCWE613 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-613"), "Insufficient Session Expiration", "https://cwe.mitre.org/data/definitions/613.html")},
	...
	MetaCWE565 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-565"), "Reliance on Cookies without Validation and Integrity Checking", "https://cwe.mitre.org/data/definitions/565.html")},
	...
	MetaCWE807 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-807"), "Reliance on Untrusted Inputs in a Security Decision", "https://cwe.mitre.org/data/definitions/807.html")},
	...
	MetaCWE698 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-698"), "Execution After Redirect (EAR)", "https://cwe.mitre.org/data/definitions/698.html")},
