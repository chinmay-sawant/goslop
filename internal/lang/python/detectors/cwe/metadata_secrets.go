...
var (
	MetaCWE798 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-798"), "Use of Hard-coded Credentials", "https://cwe.mitre.org/data/definitions/798.html")},
	...
	MetaCWE256 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-256"), "Plaintext Storage of a Password", "https://cwe.mitre.org/data/definitions/256.html")},
	...
	MetaCWE260 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-260"), "Password in Configuration File", "https://cwe.mitre.org/data/definitions/260.html")},
	...
	MetaCWE261 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-261"), "Weak Encoding for Password", "https://cwe.mitre.org/data/definitions/261.html")},
	...
	MetaCWE312 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-312"), "Cleartext Storage of Sensitive Information", "https://cwe.mitre.org/data/definitions/312.html")},
	...
	MetaCWE319 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-319"), "Cleartext Transmission of Sensitive Information", "https://cwe.mitre.org/data/definitions/319.html")},
	...
	MetaCWE547 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-547"), "Use of Hard-coded, Security-relevant Constants", "https://cwe.mitre.org/data/definitions/547.html")},
	...
	MetaCWE523 = rules.Meta(
		...
		rules.SeverityHigh,
		[]cwe.CweRef{cwe.New(cweNumber("CWE-523"), "Unprotected Transport of Credentials", "https://cwe.mitre.org/data/definitions/523.html")},
