...
var (
	MetaCWE295 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-295"), "Improper Certificate Validation", "https://cwe.mitre.org/data/definitions/295.html")},
	...
	MetaCWE328 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-328"), "Use of Weak Hash", "https://cwe.mitre.org/data/definitions/328.html")},
	...
	MetaCWE335 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-335"), "Incorrect Usage of Seeds in Pseudo-Random Number Generator (PRNG)", "https://cwe.mitre.org/data/definitions/335.html")},
	...
	MetaCWE338 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-338"), "Use of Cryptographically Weak Pseudo-Random Number Generator (PRNG)", "https://cwe.mitre.org/data/definitions/338.html")},
	...
	MetaCWE347 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-347"), "Improper Verification of Cryptographic Signature", "https://cwe.mitre.org/data/definitions/347.html")},
	...
	MetaCWE1204 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-1204"), "Generation of Weak Initialization Vector (IV)", "https://cwe.mitre.org/data/definitions/1204.html")},
	...
	MetaCWE1240 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-1240"), "Use of a Cryptographic Primitive with a Risky Implementation", "https://cwe.mitre.org/data/definitions/1240.html")},
	...
	MetaCWE1241 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-1241"), "Use of Predictable Algorithm in Random Number Generator", "https://cwe.mitre.org/data/definitions/1241.html")},
	...
	MetaCWE1392 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-1392"), "Use of Default Credentials", "https://cwe.mitre.org/data/definitions/1392.html")},
