...
var (
	MetaCWE73 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-73"), "External Control of File Name or Path", "https://cwe.mitre.org/data/definitions/73.html")},
	...
	MetaCWE59 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-59"), "Improper Link Resolution Before File Access ('Link Following')", "https://cwe.mitre.org/data/definitions/59.html")},
	...
	MetaCWE41 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-41"), "Improper Resolution of Path Equivalence", "https://cwe.mitre.org/data/definitions/41.html")},
	...
	MetaCWE276 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-276"), "Incorrect Default Permissions", "https://cwe.mitre.org/data/definitions/276.html")},
	...
	MetaCWE378 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-378"), "Creation of Temporary File With Insecure Permissions", "https://cwe.mitre.org/data/definitions/378.html")},
	...
	MetaCWE426 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(cweNumber("CWE-426"), "Untrusted Search Path", "https://cwe.mitre.org/data/definitions/426.html")},
	...
	MetaCWE250 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-250"), "Execution with Unnecessary Privileges", "https://cwe.mitre.org/data/definitions/250.html")},
	...
	MetaCWE494 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(cweNumber("CWE-494"), "Download of Code Without Integrity Check", "https://cwe.mitre.org/data/definitions/494.html")},
