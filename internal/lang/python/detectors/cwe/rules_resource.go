...
func detectCWE434(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
	if unit == nil || out == nil {
		return
	}
	for _, fn := range pythonFunctions(unit.Source) {
		masked := pythonCodeMask(fn.body)
...
func detectCWE427(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
	if unit == nil || out == nil {
		return
	}
...
func detectCWE379(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
	if unit == nil || out == nil {
		return
	}
...
func detectCWE459(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
	if unit == nil || out == nil {
		return
	}
	for _, fn := range pythonFunctions(unit.Source) {
		...
		for _, call := range findCalls(fn.body, "tempfile.mkstemp", "tempfile.NamedTemporaryFile") {
...
func detectCWE772(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
	if unit == nil || out == nil {
		return
	}
	for _, fn := range pythonFunctions(unit.Source) {
...
func detectCWE770(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
...
func detectCWE708(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
	if unit == nil || out == nil {
		return
	}
...
func detectCWE477(unit *core.ParsedUnit, _ *PyCweFacts, out *[]rules.Finding) {
	if unit == nil || out == nil {
		return
	}
