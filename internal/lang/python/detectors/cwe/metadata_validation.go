...
var (
	MetaCWE1173 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(1173, "Improper Use of Validation Framework", "https://cwe.mitre.org/data/definitions/1173.html")},
	...
	MetaCWE1230 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(1230, "Exposure of Sensitive Information Through Metadata", "https://cwe.mitre.org/data/definitions/1230.html")},
	...
	MetaCWE1236 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(1236, "Improper Neutralization of Formula Elements in a CSV File", "https://cwe.mitre.org/data/definitions/1236.html")},
	...
	MetaCWE1286 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(1286, "Improper Validation of Syntactic Correctness of Input", "https://cwe.mitre.org/data/definitions/1286.html")},
	...
	MetaCWE1289 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(1289, "Improper Validation of Unsafe Equivalence in Input", "https://cwe.mitre.org/data/definitions/1289.html")},
	...
	MetaCWE1333 = rules.Meta(
		...
		rules.SeverityHigh, []cwe.CweRef{cwe.New(1333, "Inefficient Regular Expression Complexity", "https://cwe.mitre.org/data/definitions/1333.html")},
	...
	MetaCWE1389 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(1389, "Incorrect Parsing of Numbers with Different Radices", "https://cwe.mitre.org/data/definitions/1389.html")},
	...
	MetaCWE140 = rules.Meta(
		...
		rules.SeverityMedium, []cwe.CweRef{cwe.New(140, "Improper Neutralization of Delimiters", "https://cwe.mitre.org/data/definitions/140.html")},
