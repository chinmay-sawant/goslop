...
func TestBPFalsePositiveAuditFixtureVariants(t *testing.T) {
	...
	for _, tc := range []struct {
		...
		{rule: "BP-PY-1", caseName: "BP-PY-1-stream-receive-break"},
		{rule: "BP-PY-1", caseName: "BP-PY-1-logging-handle-error"},
		{rule: "BP-PY-1", caseName: "BP-PY-1-http-error-response"},
		{rule: "BP-PY-1", caseName: "BP-PY-1-health-status"},
		...
		{rule: "BP-PY-2", caseName: "BP-PY-2-conversion-enrichment"},
		{rule: "BP-PY-2", caseName: "BP-PY-2-expected-marker"},
		{rule: "BP-PY-2", caseName: "BP-PY-2-sync-expected-call"},
		{rule: "BP-PY-2", caseName: "BP-PY-2-offline-tools"},
		...
		{rule: "BP-PY-41", caseName: "BP-PY-41-route-handler"},
		{rule: "BP-PY-41", caseName: "BP-PY-41-subprocess-check"},
		{rule: "BP-PY-41", caseName: "BP-PY-41-validate-helper"},
		...
		{rule: "BP-PY-45", caseName: "BP-PY-45-path-join-subpath"},
