...
| `lang/python/` | `lang/python/` (stub/WIP) | v0.0.2 / [#39](https://github.com/chinmay-sawant/goslop/issues/39) | [~] foundation WIP — see [`plans/v0.0.2/python-support.md`](./v0.0.2/python-support.md); catalogues → #43 `ruleset/python/`; not full detector parity |
...
| `tests/fixtures/python/**` | small | [~] reserved for plugin; catalogue seeds in `ruleset/python/` (#43); epic [#39](https://github.com/chinmay-sawant/goslop/issues/39) / [`plans/v0.0.2/python-support.md`](./v0.0.2/python-support.md) |
