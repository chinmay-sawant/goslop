...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-749-vulnerable.txt` + `-safe.txt`
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-829-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-695-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-214-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-215-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
