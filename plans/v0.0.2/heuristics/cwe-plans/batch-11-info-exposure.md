...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-209-vulnerable.txt` + `-safe.txt`
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-208-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-201-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-204-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-212-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-213-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-497-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
...
- [ ] Fixtures: `tests/fixtures/python/cwe/CWE-488-vulnerable.txt` + `-safe.txt`
- [ ] Matrix discovers pair via integration python CWE suite
