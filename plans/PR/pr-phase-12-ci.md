...
```
$ CGO_ENABLED=1 go test ./...
ok  github.com/chinmay/codehound/tests/integration   0.008s
# ... all packages PASS
```
...
CI workflow and integration-test scaffolding for the CodeHound Go port (Phase 12 partial). Product parity oracle (§12.4) still pending.
